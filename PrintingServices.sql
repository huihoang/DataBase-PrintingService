...
-- Tạo bảng Default_FileTypes
--CREATE TABLE SystemService.Default_FileTypes (
--	DefaultConfigId VARCHAR(50),
--	PermittedFileType VARCHAR(10),
--	CONSTRAINT PK_DefaultFileTypes_DefaultConfigId_PermittedFileType PRIMARY KEY (DefaultConfigId, PermittedFileType),
--	CONSTRAINT FK_DefaultFileTypes_DefaultConfigId FOREIGN KEY (DefaultConfigId) REFERENCES SystemService.DefaultConfiguration(Id)
--);
