...
CREATE OR ALTER PROCEDURE PrintService.RequestPrint (
...
EXECUTE PrintService.RequestPrint 'One-Sided', 1, 'A4', 'C002', 1; 
DROP PROCEDURE PrintService.RequestPrint;
GO

-- Máy in gửi phản hồi lần in đó thành công hoặc thất bại
CREATE OR ALTER PROCEDURE PrintService.UpdateStatus (
	@Status NVARCHAR(50),
    @CustomerId VARCHAR(50),
    @PrinterId INT
	)
...
-- thực thi ví dụ
EXECUTE PrintService.UpdateStatus 'Failed', 'C002', 2;
DROP PROCEDURE PrintService.UpdateStatus;
GO
